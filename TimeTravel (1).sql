...
INSERT INTO CURRENCY_ORDER (PersonID, OrderQuantity, CurrencyTypeID, DesiredCurrencyDate)
VALUES (@PersonID, @OrderQty, @CurrencyTypeID, @DesiredCurrencyDate)
COMMIT TRAN
...
INSERT INTO MAINTENANCE (MaintenanceName, PortalID, MaintenanceTypeID)
VALUES (@MaintenanceName, @PortalID, @MaintenanceTypeID)
COMMIT TRAN
